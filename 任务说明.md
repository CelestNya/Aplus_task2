...
这个模属于有点风格化，不是谁都喜欢这个风格，而且由于训练集可能比较少，很多动作下容易出现肢体错误，需要抽好久卡才能得到满意的结果。
...
- 2.2.3.1 在Transformer中运行模型
    ...
    问题：但是vl之类的还是可能出现依赖装不上、没有对应版本的问题。目前该代码只能跑原生模型且只能进行文本输出，输入awq、gptq等量化都会报错。
...
### 3. 试图理解 Attention is All You Need 心得
